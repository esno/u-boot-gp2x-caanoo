...
enum {
	...
	CFG_SYS_BANKA_CASLAT		= 3,		// CAS latency              : 0=1.0, 1=2.0, 2=2.5, 3=3.0 clocks
	CFG_SYS_BANKA_READLAT		= 3,		// Read latency             : 0=1.0, 1=2.0, 2=2.5, 3=3.0 clocks
	CFG_SYS_BANKA_TMRD			= 3,		// Mode Register Set Cycle  : 1 ~ 16 clocks
	CFG_SYS_BANKA_TRP			= 3, 		// Row Prechage Time        : 1 ~ 16 clocks
	CFG_SYS_BANKA_TRCD			= 3, 		// RAS to CAS delay         : 1 ~ 16 clocks
	CFG_SYS_BANKA_TRC			= 10, 		// Row Cycle Time           : 1 ~ 16 clocks
	CFG_SYS_BANKA_TRAS			= 6, 		// Row Active Time          : 1 ~ 16 clocks
	...
	CFG_SYS_BANKA_DQS0INDLY		= 5, 		// delay of DQS0 Input      : 0=0, 1=0.5, 2=1, 3=1.5, 4=2, 5=2.5, 6=3, 7=3.5 (ns)
	CFG_SYS_BANKA_DQS0OUTDLY	= 5, 		// delay of DQS0 Output     : 0=0, 1=0.5, 2=1, 3=1.5, 4=2, 5=2.5, 6=3, 7=3.5 (ns)
	CFG_SYS_BANKA_DQS1INDLY		= 5, 		// delay of DQS1 Input      : 0=0, 1=0.5, 2=1, 3=1.5, 4=2, 5=2.5, 6=3, 7=3.5 (ns)
	CFG_SYS_BANKA_DQS1OUTDLY	= 5, 		// delay of DQS1 Output     : 0=0, 1=0.5, 2=1, 3=1.5, 4=2, 5=2.5, 6=3, 7=3.5 (ns)
};
...
CFG_SYS_STATICBUS_CONFIG( STATIC1, 16,    2,   3,  16,    2,    3,   3,  0,  0,  0 )  /* DM9000A timing */
...
//CFG_SYS_STATICBUS_CONFIG(    NAND,  8,    2,   2,   4,    3,   2,   2,  1,  0,  0 )	// tOCH, tCAH must be greter than 0 for NAND
//CFG_SYS_STATICBUS_CONFIG(    NAND,  8,    1,   1,   4,    3,   2,   2,  1,  0,  0 )		// tOCH, tCAH must be greter than 0 for NAND
//CFG_SYS_STATICBUS_CONFIG(    NAND,  8,    2,   2,   3,    2,   1,   1,  1,  0,  0 )	// tOCH, tCAH must be greter than 0 for NAND
//CFG_SYS_STATICBUS_CONFIG(    NAND,  8,    1,   1,   3,    2,   1,   1,  1,  0,  0 )	// tOCH, tCAH must be greter than 0 for NAND like to Aiji Board Setting [bnjang 2008.12.31]
CFG_SYS_STATICBUS_CONFIG(    NAND,  8,    1,   1,   3,    2,   1,   1,  1,  0,  0 )		//tOCH, tCAH must be greter than 0 for NAND
...
#define SYSTEM_CLOCK_CPU_AHBDIV                           					4			    /* 530.5 / 4 = 132.6 */		

#define SYSTEM_CLOCK_BCLK_SELPLL                          					SEL_PLL1
#define SYSTEM_CLOCK_BCLK_DIV                             					2			    /* 261000000 / 2 = 130.5 */

#define SYSTEM_CLOCK_TIMER_SELPLL                         					SEL_PLL1        /* 261000000 / 50 = 5.22 */
#define SYSTEM_CLOCK_TIMER_DIV                            					50

#define SYSTEM_CLOCK_PWM_SELPLL                           					SEL_PLL1
#define SYSTEM_CLOCK_PWM_DIV                              					64 		   	    /* 261000000 / 64 = 4.07 MHZ */

#define SYSTEM_CLOCK_USB_SELPLL                           					SEL_PLL0
#define SYSTEM_CLOCK_USB_DIV                              					8
																					    
#define SYSTEM_CLOCK_UART_SELPLL                          					SEL_PLL1
#define SYSTEM_CLOCK_UART_DIV                             					46              /* (261000000 / 46 ) / 1843200(16x115200) = 3.00 -1 */

#define SYSTEM_CLOCK_SDMMC_SELPLL											SEL_PLL1   
#define SYSTEM_CLOCK_SDMMC_DIV												3

#define SYSTEM_CLOCK_AUDIO_SELPLL											SEL_PLL0

//// DEBUGGER_PORT ////
#define SYSTEM_DEBUG_USE_UART                             					CTRUE
#define SYSTEM_DEBUG_UART_PORT                            					0
#define SYSTEM_DEBUG_UART_PHY_REG                         					PHY_BASEADDR_UART3
#define SYSTEM_DEBUG_UART_VIR_REG                         					VIR_BASEADDR_UART3
#define SYSTEM_DEBUG_UART_BAUD                            					115200

//// WAKEUP ////
#define SYSTEM_WAKEUP_SOURCE                              					CTRUE
#define SYSTEM_WAKEUP_VDDF_BATTF                          					CFALSE

//// LED ////
#define SYSTEM_LED_USE_LED_IDLE                           					CFALSE
#define SYSTEM_LED_USE_MEDIA_LED                          					CFALSE

//// EXTETHER ////
#define SYSTEM_EXTETHER_PHY_BASEADDR_ETHER                					0x84000000
...
#define DISPLAY_MAIN_DISPLAY_SCREEN                        					DISP_PRI_MAIN_SCREEN
...
#define DISPLAY_DPC_PRI_VCLK_DIV                          				    28                  /* 260357805 / 28 = 9.2 */
#define DISPLAY_DPC_PRI_VCLK_DIV_TCL                          				23                  /* 260357805 / 23 = 11.3 */
...
#define DISPLAY_DPC_PRI_CLOCK_INVERT                        			    CTRUE //CFALSE
...
#define AUDIO_ENABLE_AC97                                 					CTRUE
#define AUDIO_ENABLE_I2S                                  					CFALSE
...
/*************** DMA LIST ***************/
#define DMA_DMB_SPI_READ                                  			0
#define DMA_DMB_SPI_READ_IRQ                              			IRQ_VIR0
#define DMA_DMB_SPI2_READ                                 			1
#define DMA_DMB_SPI2_READ_IRQ                             			IRQ_VIR1
#define DMA_IDE_PIO_READ                                  			2
#define DMA_IDE_PIO_READ_IRQ                              			IRQ_VIR2
#define DMA_AUDIO_PLAY                                    			3
#define DMA_AUDIO_PLAY_IRQ                                			IRQ_VIR3
#define DMA_AUDIO_REC                                     			4
#define DMA_AUDIO_REC_IRQ                                 			IRQ_VIR4
#define DMA_SD_CARD_READ                                  			6
#define DMA_SD_CARD_READ_IRQ                              			IRQ_VIR5
#define DMA_SD_CARD_WRITE                                 			7
#define DMA_SD_CARD_WRITE_IRQ                             			IRQ_VIR6
#define DMA_DMB_SPI_WRITE                                 			10
#define DMA_DMB_SPI_WRITE_IRQ                             			IRQ_VIR7
#define DMA_DMB_SPI2_WRITE                                			11
#define DMA_DMB_SPI2_WRITE_IRQ                            			IRQ_VIR8

#define DMA_IRQ { \
DMA_DMB_SPI_READ_IRQ, \
DMA_DMB_SPI2_READ_IRQ, \
DMA_IDE_PIO_READ_IRQ, \
DMA_AUDIO_PLAY_IRQ, \
DMA_AUDIO_REC_IRQ, \
-1, \
DMA_SD_CARD_READ_IRQ, \
DMA_SD_CARD_WRITE_IRQ, \
-1, \
-1, \
DMA_DMB_SPI_WRITE_IRQ, \
DMA_DMB_SPI2_WRITE_IRQ, \
-1, \
-1, \
-1, \
-1, \
